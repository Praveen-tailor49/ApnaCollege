...
export const markAttendance = (data) =>
  ...
  export const getStudentSubject = (data) =>
  API.post("/api/faculty/getSubjectStudent", data);
...
export const getAttendance = (attendance) =>
  ...
  export const getStudentMarks = (result) =>
  API.post("/api/student/getstudentmarks", result);
